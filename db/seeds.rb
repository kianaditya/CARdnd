...
Automobile.create(id: 1, brand: "Volvo", model: "V60", year: 1985, price: 540, user_id: 1,rental_status: true)
Automobile.create(id:2, brand: "Tolvo", model: "T01", year: 1990, price: 400, user_id: 1, rental_status: true)
Automobile.create(id:3, brand: "Polvo", model: "P60", year: 1981, price: 850, user_id: 1,rental_status: false)
