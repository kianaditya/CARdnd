...
ActiveRecord::Schema.define(version: 2018_12_08_142817) do
  ...
  create_table "rentals", force: :cascade do |t|
    ...
    t.index ["automobile_id"], name: "index_rentals_on_automobile_id"
  ...
  add_foreign_key "rentals", "automobiles"
